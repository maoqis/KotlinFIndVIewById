 ...
 *
 */
infix fun Project.isExtendsBaseAdapterDelegate(mClass: PsiClass): Boolean {
    // 根据类名查找类
    val activityClass = this findClassByProject "com.mivideo.mifm.base.adapter.BaseAdapterDelegate"
    val activityCompatClass = this findClassByProject "com.mivideo.mifm.base.adapter.BaseAdapterDelegate"
    return activityClass != null && mClass checkInheritor activityClass
            || activityCompatClass != null && mClass checkInheritor activityCompatClass
}
/**
